...
def filter_genes(input_file, output_file):
    """
    Reads the input file, filters out genes with labels 'UP' and 'NON',
        ...
        with open(output_file, 'w') as outfile:
            for line in infile:
                ...
                if len(parts) > 1:
                    ...
                    # Filter out genes with labels 'UP' and 'NON'
                    filtered_genes = [gene for gene in genes if '(DOWN)' in gene]
